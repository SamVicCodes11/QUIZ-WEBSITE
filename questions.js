let frontendQuiz = [
    ...
    {
        numb: 10,
        question: "What is the main purpose of the section tag in HTML5?",
        answer: "B. To define sections within a document",
        options: [
            "A. To group header elements",
            "B. To define sections within a document",
            "C. To display a horizontal line",
            "D. To create an interactive element"
        ]
    },
    {
        numb: 11,
        question: "How do you apply a CSS rule only when the screen width is less than 768px?",
    ...
    {
        numb: 12,
        question: "Which JavaScript array method is used to create a new array with elements that pass a test?",
        answer: "A. filter()",
    ...
    },
    {
        ...
        options: ["A. font-weight", "B. text-style", "C. font-style", "D. text-decoration"]
    }
];
